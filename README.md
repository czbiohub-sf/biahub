...
biahub (bioimage analysis hub) is a pipeline to turn raw high throughput imaging data into AI ready nD datasets on HPC clusters running on [Slurm](https://slurm.schedmd.com/documentation.html) workload management.

![biahub schematic](https://github.com/czbiohub-sf/shrimPy/blob/main/docs/figure_3a.png)
