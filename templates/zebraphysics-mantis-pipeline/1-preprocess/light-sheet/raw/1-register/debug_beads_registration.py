...
dataset = '2025_09_12_52hpf_cldnb-she-myo6b'
fov = '0/8/000000'
root_path = Path(f'/hpc/projects/tlg2_mantis/{dataset}/1-preprocess/')
t_idx = 76
...
config_dict = {
    ...
    "beads_match_settings": {
        ...
        "filter_angle_threshold": 60,
    },
    "affine_transform_settings": {
        "transform_type": "similarity",
        "approx_transform": [
            [0.9907113909721375, 0.01176353357732296, -0.0023756297305226326, 11.669376373291016],
            [-0.0027884417213499546, -0.022817790508270264, -1.2758545875549316, 1199.9306640625],
            [-0.015202872455120087, 1.2757678031921387, -0.022782862186431885, -5.484277725219727],
            [0.0, 0.0, 0.0, 1.0]
        ]
    },
