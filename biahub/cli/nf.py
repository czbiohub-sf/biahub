...
def run_flat_field(input_zarr: str, output_zarr: str, position: str, config: str):
    ...
    target_channel_names = (
        settings.channel_names if settings.channel_names else all_channel_names
    )
...
# ---------------------------------------------------------------------------
#
# Deskew init/run live in biahub.deskew. The Nextflow processes call
# `biahub deskew --init` and `biahub deskew --executor debug` directly.
